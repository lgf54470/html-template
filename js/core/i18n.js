...
(function () {
  ...
  var dict = {
    en: {
      ...
      'auth.serverRequired': 'Server unreachable — start the app via `node server.js`.',
    ...
    'zh-CN': {
      ...
      'auth.serverRequired': '无法连接服务器,请通过 node server.js 启动应用后再登录。',
      'auth.expiry.3h': '3 小时',
      'auth.expiry.6h': '6 小时',
      'auth.expiry.9h': '9 小时',
    ...
    'zh-TW': {
      ...
      'auth.serverRequired': '無法連線伺服器,請透過 node server.js 啟動應用程式後再登入。',
      'auth.expiry.3h': '3 小時',
      'auth.expiry.6h': '6 小時',
      'auth.expiry.9h': '9 小時',
