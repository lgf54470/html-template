...
(function () {
  ...
  var dict = {
    en: {
      ...
      'workspace.name.work': 'Work',
      'workspace.name.study': 'Study',
      'workspace.name.life': 'Life',
      'workspace.name.fun': 'Entertainment',
      'workspace.name.travel': 'Travel',
      'auth.title': 'Sign in',
    ...
    'zh-CN': {
      ...
      'workspace.create': '创建',
      'workspace.cancel': '取消',
      'workspace.name.default': '默认',
      'workspace.name.work': '工作',
      'workspace.name.study': '学习',
      'workspace.name.life': '生活',
      'workspace.name.fun': '娱乐',
      'workspace.name.travel': '旅游',
      'auth.title': '登录',
    ...
    'zh-TW': {
      ...
      'workspace.nameLabel': '名稱',
      'workspace.namePlaceholder': '輸入工作空間名稱',
      'workspace.iconLabel': '圖示',
      'workspace.colorLabel': '顏色',
      'workspace.create': '建立',
      'workspace.cancel': '取消',
      'workspace.name.default': '預設',
      'workspace.name.work': '工作',
      'workspace.name.study': '學習',
      'workspace.name.life': '生活',
      'workspace.name.fun': '娛樂',
      'workspace.name.travel': '旅遊',
      'auth.title': '登入',
