/* ============================================================
 * dashboard 模块 — 模块词典(懒加载:首次访问该模块路由时随实现一起下载)
...
window.__moduleI18n['dashboard'] = {
  "en": {
    ...
    "home.welcomeDesc": "This is a pure HTML/JS/CSS admin template — a draggable / collapsible sidebar, frosted-glass header and a single scrolling content region, with zero external dependencies.",
  ...
  "zh-CN": {
    ...
    "home.welcomeDesc": "这是一个纯 HTML/JS/CSS 管理后台模板——可拖拽/可折叠侧边栏、毛玻璃顶栏与单一内容滚动区,零外部依赖。",
    "home.overview": "概览",
  ...
  "zh-TW": {
    ...
    "home.welcomeDesc": "這是一個純 HTML/JS/CSS 管理後台模板——可拖曳/可收合側邊欄、毛玻璃頂欄與單一內容捲動區,零外部依賴。",
    "home.overview": "總覽",
