 ...
 * 本模块全部文案集中在 i18n 字段(模块内聚,不进核心词典)。
 * ============================================================ */
App.registerModule({
  id: 'docs',
  ...
  i18n: {
    en: {
      ...
      'docs.getStarted.step2': 'Write manifest.js (metadata) + module.js (implementation)',
      ...
      'docs.tutorials.s1p': 'Declares id, trilingual title, icon, route, optional css, per-module i18n and children:',
      'docs.tutorials.code1':
        "App.registerModule({ id: 'mymod', title: { en: 'My Mod', 'zh-CN': '我的模块' }, icon: 'settings', route: '/mymod', load: 'module.js', i18n: { ... } })",
    ...
    'zh-CN': {
      ...
      'docs.getStarted.step2': '编写 manifest.js(元信息)+ module.js(实现)',
      ...
      'docs.tutorials.s1p': '声明 id、三语言标题、图标、路由、可选 css、模块内 i18n 与 children:',
      'docs.tutorials.code1':
        "App.registerModule({ id: 'mymod', title: { en: 'My Mod', 'zh-CN': '我的模块' }, icon: 'settings', route: '/mymod', load: 'module.js', i18n: { ... } })",
    ...
    'zh-TW': {
      ...
      'docs.getStarted.step2': '編寫 manifest.js(元資訊)+ module.js(實作)',
      ...
      'docs.tutorials.s1p': '宣告 id、三語言標題、圖示、路由、可選 css、模組內 i18n 與 children:',
      'docs.tutorials.code1':
        "App.registerModule({ id: 'mymod', title: { en: 'My Mod', 'zh-CN': '我的模組' }, icon: 'settings', route: '/mymod', load: 'module.js', i18n: { ... } })",
